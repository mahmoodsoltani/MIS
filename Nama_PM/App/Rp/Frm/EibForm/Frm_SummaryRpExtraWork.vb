Public Class Frm_SummaryRpExtraWork
    ...
    Private Sub btn_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Save.Click
        ...
        Me.Rp_SummaryExtraWorkTableAdapter.Fill(Me.Ds_Rp.Rp_SummaryExtraWork, srl_vahed, srl_group, txt_FromDate.Value, txt_ToDate.Value)
    ...
    Private Sub btn_Fanavaran_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Fanavaran.Click
        Dim srl_vahed = -1
        If Not chk_Vahed.Checked Then
            srl_vahed = cmb_Vahed.SelectedValue
        End If
        ...
        If Not chk_Group.Checked Then
            srl_group = cmb_Group.SelectedValue
        End If
        Dim rp1 As New Rp_SummaryExtraWorkF
        Me.Rp_SummaryExtraWorkFanavaranTableAdapter.Fill(Me.Ds_Rp.Rp_SummaryExtraWorkFanavaran, srl_vahed, srl_group, txt_FromDate.Value, txt_ToDate.Value)
    ...
    '        Dim rp1 As New Rp_SummaryExtraWorkF
    '        Me.Rp_SummaryExtraWorkFanavaranTableAdapter.Fill(Me.Ds_Rp.Rp_SummaryExtraWorkFanavaran, txt_FromDate.Value, txt_ToDate.Value)
    ...
    '        Dim frm_rp1 As New Frm_RpVw(rp1, Me.Ds_Rp.Rp_SummaryExtraWorkFanavaran.DataSet.Tables("0"))
    '        frm_rp1.ShowDialog()
    '    ElseIf ComboBox1.SelectedValue = 2 Then
    '        Dim rp As New Rp_SummaryExtraWork
    '        Me.Rp_SummaryExtraWorkTableAdapter.Fill(Me.Ds_Rp.Rp_SummaryExtraWork, txt_FromDate.Value, txt_ToDate.Value)
    ...
    Private Sub btn_Report_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Report.Click
        ...
        ElseIf ComboBox1.SelectedValue = 2 Then
            ...
            If Not chk_Group.Checked Then
                srl_group = cmb_Group.SelectedValue
            End If
            Dim rp As New Rp_SummaryExtraWorkF
            Me.Rp_SummaryExtraWorkTableAdapter.Fill(Me.Ds_Rp.Rp_SummaryExtraWork, srl_vahed, srl_group, txt_FromDate.Value, txt_ToDate.Value)
