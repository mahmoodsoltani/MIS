Public Class Frm_RpNafarSatProjectGraph

    Public Sub New(ByVal begindate As String, ByVal enddate As String, ByVal selectedProject As Integer)
        InitializeComponent()
        Dim rp As New Rp_NafarSatProject
        Rp_NafarSatProjectTableAdapter.Fill(Me.Ds_Rp.Rp_NafarSatProject, begindate, enddate, selectedProject)
    ...
    Private Sub Frm_RpNafarSatProjectGraph_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
