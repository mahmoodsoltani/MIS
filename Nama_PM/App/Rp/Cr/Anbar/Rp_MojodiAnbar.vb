...
Public Class Rp_MojodiAnbar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nama_PM.Rp_MojodiAnbar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRp_MojodiAnbar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rp_MojodiAnbar = New Rp_MojodiAnbar
        rpt.Site = Me.Site
        Return rpt
    End Function
