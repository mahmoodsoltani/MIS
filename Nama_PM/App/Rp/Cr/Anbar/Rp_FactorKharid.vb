...
Public Class Rp_FactorKharid
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nama_PM.Rp_FactorKharid.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRp_FactorKharid
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rp_FactorKharid = New Rp_FactorKharid
        rpt.Site = Me.Site
        Return rpt
    End Function
