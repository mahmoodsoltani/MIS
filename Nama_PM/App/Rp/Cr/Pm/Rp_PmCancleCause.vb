...
Public Class Rp_PmCancleCause
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nama_PM.Rp_PmCancleCause.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRp_PmCancleCause
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rp_PmCancleCause = New Rp_PmCancleCause
        rpt.Site = Me.Site
        Return rpt
    End Function
