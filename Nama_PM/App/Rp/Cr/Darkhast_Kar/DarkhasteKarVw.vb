...
Public Class DarkhasteKarVw
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nama_PM.DarkhasteKarVw.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDarkhasteKarVw
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DarkhasteKarVw = New DarkhasteKarVw
        rpt.Site = Me.Site
        Return rpt
    End Function
