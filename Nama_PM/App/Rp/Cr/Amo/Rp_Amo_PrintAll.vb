...
Public Class Rp_Amo_PrintAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nama_PM.Rp_Amo_PrintAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRp_Amo_PrintAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rp_Amo_PrintAll = New Rp_Amo_PrintAll
        rpt.Site = Me.Site
        Return rpt
    End Function
