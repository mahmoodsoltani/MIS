...
Public Class Rp_Hadese_PrintAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nama_PM.Rp_Hadese_PrintAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRp_Hadese_PrintAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rp_Hadese_PrintAll = New Rp_Hadese_PrintAll
        rpt.Site = Me.Site
        Return rpt
    End Function
