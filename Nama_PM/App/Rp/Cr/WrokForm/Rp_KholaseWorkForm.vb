...
Public Class Rp_KholaseWorkForm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nama_PM.Rp_KholaseWorkForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRp_KholaseWorkForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rp_KholaseWorkForm = New Rp_KholaseWorkForm
        rpt.Site = Me.Site
        Return rpt
    End Function
