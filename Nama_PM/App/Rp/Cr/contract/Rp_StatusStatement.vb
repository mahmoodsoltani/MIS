...
Public Class Rp_StatusStatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nama_PM.Rp_StatusStatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRp_StatusStatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rp_StatusStatement = New Rp_StatusStatement
        rpt.Site = Me.Site
        Return rpt
    End Function
