...
Public Class Rp_MultiExtraworkF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nama_PM.Rp_MultiExtraworkF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRp_MultiExtraworkF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rp_MultiExtraworkF = New Rp_MultiExtraworkF
        rpt.Site = Me.Site
        Return rpt
    End Function
