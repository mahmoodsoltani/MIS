...
Public Class Rp_Group_EibForm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nama_PM.Rp_Group_EibForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRp_Group_EibForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rp_Group_EibForm = New Rp_Group_EibForm
        rpt.Site = Me.Site
        Return rpt
    End Function
