...
/****** Object:  StoredProcedure [dbo].[Rp_EzafeKar]    Script Date: 05/09/2011 22:26:17 ******/
...
as
BEGIN
select WorkFormTarikh as تاریخ,Pm_Ashkhas.Name+' '+Pm_Ashkhas.Family  as [نام فرد],
...
ANd Pm_taghvim.Tarikh = WorkFormTarikh ) as تعطیل
...
Srl_Pm_Post_To  = Pm_Post.Srl 
 union 
select Pm_TimeCard.Tarikh as تاریخ,Pm_Ashkhas.Name as [نام فرد],Pm_Ashkhas.PersonalCode as [کد شناسایی],
