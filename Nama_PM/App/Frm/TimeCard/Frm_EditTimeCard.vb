Public Class Frm_EditTimeCard
    ...
    Private Sub Frm_Vahed_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txt_BeginDate.Value = Setting.TarikheJary.Remove(8) + "01"
        txt_EndDate.Value = Setting.TarikheJary.Remove(8) + "30"
        Me.Acc_AshkhasTableAdapter.Fill(Me.Ds_Ashkhas.Acc_Ashkhas)
        Btn_ViewSave.Enabled = False
        txt_Number.Value = BaseDataObject.DataAccess.FindMax("pm_timeCard", "TimeCardNumber", "")

        'Dim tscol As New TimeColumn()
        'Me.DataGridView1.Columns.Add(tscol)

        'Dim tscol As New ComboBoxColumn()
        'Dim tscol2 As New System.Windows.Forms.DataGridViewComboBoxColumn
        'tscol.
        'Me.DataGridView1.Columns.Add(tscol)

        MyBase.StatusStrip1.Items.Clear()
        MyBase.StatusStrip1.Items.Add("F4 گزارش مشروح اضافه کار")
        MyBase.StatusStrip1.Items.Add("-")
        MyBase.StatusStrip1.Items.Add("F5 کد هزینه")
        MyBase.StatusStrip1.Items.Add("-")
        MyBase.StatusStrip1.Items.Add("F6 اضافه کردن روز  جدید")
        MyBase.StatusStrip1.Items.Add("-")
        MyBase.StatusStrip1.Items.Add("F7 ذخیره تغییرات جدول")
        MyBase.StatusStrip1.Items.Add("-")
        NewDay()
    ...
    Private Sub btn_Search_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PictureBox1.Click
    ...
    Private Sub Btn_SaveNumber_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_SaveNumber.Click
        If txt_Number.Text <> "" Then
            'If ISChanged Then
