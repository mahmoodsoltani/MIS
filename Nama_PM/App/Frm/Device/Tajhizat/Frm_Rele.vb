Public Class Frm_Rele
    ...
    Public Sub New(ByVal TreeToUpdate As VB_Component.TreeNode, ByVal UpdateMode As Boolean, ByVal srl_post As Integer)
        ...
        If UpdateMode Then
            ...
            cmb_ANSICode.SelectedValue = IIf(dr_load("AnsiCode") Is DBNull.Value, 0, dr_load("AnsiCode"))
            txt_CT.Value = dr_load("CT")
            txt_VT.Value = dr_load("VT")
            txt_Order.Value = dr_load("OrderCode")
            txt_Utilization.Value = dr_load("UtilizationDate")

            Try
                If dr_load("Srl_Pm_Device_Sazande") <> -1 Then
                    cmb_Sazande.SelectedValue = dr_load("Srl_Pm_Device_Sazande")
                End If
    ...
    Private Sub btn_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Save.Click
        ...
        dr("AnsiCode") = cmb_ANSICode.SelectedValue
        dr("Pm_DescriptableTajhiz") = 1
