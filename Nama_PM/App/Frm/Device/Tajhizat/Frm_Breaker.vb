Public Class Frm_Breaker
    ...
    Public Sub New(ByVal TreeToUpdate As VB_Component.TreeNode, ByVal UpdateMode As Boolean, ByVal srl_post As Integer)
        ...
        If UpdateMode Then
            ...
            txt_TurnOff.Value = dr_load("TurnOffSystem")
            txt_Mekanism.Value = dr_load("MekanismType")
            txt_JaryanSC.Value = dr_load("JaryanSC")
            txt_Utilization.Value = dr_load("UtilizationDate")
            txt_Bill.Value = dr_load("Bill")
            txt_MaxJaryan.Value = dr_load("MaxJaryan")
            txt_Disconnect.Value = dr_load("DisconnectTime")
            txt_Connect.Value = dr_load("ConnectTime")
            txt_MaxVoltaje.Value = dr_load("MaxVoltaj")
            txt_VotajN.Value = dr_load("VoltajNami")
            txt_JaryanN.Value = dr_load("JaryanNami")
    ...
    Private Sub btn_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Save.Click
        ...
        dr("Pm_DescriptableTajhiz") = 5
        dr("TurnOffSystem") = txt_TurnOff.Value
        dr("MekanismType") = txt_Mekanism.Value
        dr("JaryanSC") = txt_JaryanSC.Value
        ...
        dr("MaxVoltaj") = txt_MaxVoltaje.Value
        dr("ConnectTime") = txt_Connect.Value
        dr("DisconnectTime") = txt_Disconnect.Value
        dr("VoltajNami") = txt_VotajN.Value
        dr("JaryanNami") = txt_JaryanN.Value
