Public Class Frm_Con_ContactItemsVw
    ...
    Private Sub Frm_Con_ContactItemsVw_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.Pm_Con_ContractItemsTableAdapter.Fill(Me.Ds_Con.Pm_Con_ContractItems, cmb_Vahed.SelectedValue, ContractSrl, -1)

    End Sub

    Private Sub cmb_TahvilePerson_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmb_Vahed.SelectedIndexChanged
        Me.Pm_Con_ContractItemsTableAdapter.Fill(Me.Ds_Con.Pm_Con_ContractItems, cmb_Vahed.SelectedValue, ContractSrl, -1)
    End Sub
